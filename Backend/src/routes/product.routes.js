...
import { createProduct, deleteProduct, editProduct, getProduct, getSellerProducts } from "../controller/product.controller.js";
 ...
 * @access Private (Seller only)
 */
router.get('/get/:id', authenticateSeller, getProduct)
